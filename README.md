...
- **specification**: Contains details of how the report should be displayed:
  - **template**: The type of display template to be used:
    ...
    - **parent-child-section**: A combination of both `parent-child` and `section` templates. For more information refer to [parent-child-section Template](#parent-child-section-Template).   
